...
def shoonya_http_login(cfg):
    ...
    global _shoonya_last_502
    if time.time() - _shoonya_last_502 < 300: # 5 minute cooldown after 502
        return None
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            logger.error(f"❌ Shoonya HTTP Error 502 - Entering 5-minute cooldown")
            _shoonya_last_502 = time.time()
        else:
